...
class NoiseFilter
{
    ...
    public function filter(array $rows, array $headerCells): array
    {
        ...
        return array_values(array_filter($rows, function (array $row) use ($normalizedHeader): bool {
            ...
            if (preg_match('/\b(opening balance|closing bal|brought forward|carried forward)\b/', $joined) === 1
    ...
    public function isNoiseLine(string $line): bool
    {
        ...
        if (preg_match('/\b(payments bank ltd|mahindra bank ltd|bank ltd\.?|bank limited)\b/', $normalized) === 1
